...
SELECT a1.ticket_id,
       ...
       (a5.performed_at - a1.performed_at) / 3600      AS time_till_resolution,
       -- a6 definition is removed as it is not required, time till resolution was updated to be time from open to Response
